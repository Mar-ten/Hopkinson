...
Within these, T is the period of the wave, \$w_0\$ is the fundamental frequency, n = 1,2,...2N, where N = half the number of recorded data points, C_k is the speed of a wave at the kth frequency, \$\Delta T\$ is the time step between recording intervals, and \$ \Delta x\$ is the distance the wave is being transmormed i.e. the distance from the strain gauges to the specimen. Once the waves have been transformed so they are at the same point in time, the strain gauge readings can be transformed into voltages and force values can be determined. Force on the left side of the bar is found through the equation 
